...
export const Message = ({
  ...
  const [ConfirmDialog, confirm] = useConfirm(
    "Delete Message",
    "Are you sure want to delete this message ? This cannot be undone."
  )

  const { mutate: updateMessage, isPending: isUpadatingMessage } = useUpdateMessage()
  const { mutate: removeMessage, isPending: isRemovingMessage } = useRemoveMessage()
  const { mutate: toggleReaction, isPending: isTogglingReaction } = useToggleReaction()

  const isPending = isUpadatingMessage || isRemovingMessage || isTogglingReaction;
